<div x-data="{ modalOpen: false }" 
     x-show="modalOpen"
     x-on:open-modal.window="if ($event.detail.modal === 'create-folder') { modalOpen = true }"
     x-on:close-modal.window="modalOpen = false"
     x-on:folder-created.window="modalOpen = false"
            ...
            <div class="flex justify-between items-start">
                <div>
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-gray-100">
                        Create New {{ $section_id ? 'Subfolder' : ($parameter_id ? 'Section' : 'Parameter') }}
                    </h3>
                </div>
